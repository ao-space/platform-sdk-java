...
//    }
    ...
    public void testRegisterUser() throws Exception {
        ...
        String boxRegKey = "";
        String sign = "sign";
        ObtainBoxRegKeyRequest obtainBoxRegKeyRequest = new ObtainBoxRegKeyRequest();
        obtainBoxRegKeyRequest.setBoxUUID(boxUUID);
        obtainBoxRegKeyRequest.setServiceIds(serviceIds);
        obtainBoxRegKeyRequest.setSign(sign);

// Convert ObtainBoxRegKeyRequest object to JSON
        String jsonObtainBoxRegKeyRequest = new ObjectMapper().writeValueAsString(obtainBoxRegKeyRequest);

// Adjusted method call to client.obtainBoxRegKey
        ApiResponse<ObtainBoxRegKeyResponse> obtainBoxRegKeyResponse = client.obtainBoxRegKey(jsonObtainBoxRegKeyRequest, reqId);
        if (obtainBoxRegKeyResponse.getData() != null) {
            boxRegKey = obtainBoxRegKeyResponse.getData().getTokenResults().get(0).getBoxRegKey();
        }
        ...
        // Construct RegisterUserRequest object
        ...
        // Adjusted method call to client.registerUser
        ApiResponse<RegisterUserResponse> response = client.registerUser(jsonRequest, reqId, boxRegKey);
        if (response.getData() != null) {
            // Handle the successful response
    ...
    public void testRegisterClient() throws Exception {
        ...
        // Construct RegisterClientRequest object
        RegisterClientRequest registerClientRequest = new RegisterClientRequest();
        registerClientRequest.setClientUUID(clientUUID);
        registerClientRequest.setClientType(clientType);

        // Convert RegisterClientRequest object to JSON
        String jsonRegisterClientRequest = new ObjectMapper().writeValueAsString(registerClientRequest);

        // Adjusted method call to client.registerClient
        ApiResponse<RegisterClientResponse> response = client.registerClient(boxUUID, userId, jsonRegisterClientRequest, reqId, boxRegKey);
...
//        Assert.assertNotNull("boxRegKey should not be null", boxRegKey);
//
//        ApiResponse<SpacePlatformMigrationResponse> response = client.migrateSpacePlatform(boxUUID, networkClientId, reqId, boxRegKey);
//        if (response.getData() != null) {
//            // Handle the successful response
...
//        Assert.assertNotNull("boxRegKey should not be null", boxRegKey);
//
//        ApiResponse<SpacePlatformMigrationOutResponse> response = client.migrateSpacePlatformOut(boxUUID, sign, reqId, boxRegKey);
//        if (response.getData() != null) {
//            // Handle the successful response
